...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 13, 2, 226);
    			add_location(button0, file$1, 14, 2, 252);
    			add_location(button1, file$1, 15, 2, 306);
    			add_location(article, file$1, 12, 0, 214);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	product.$on("add-to-cart", /*add_to_cart_handler*/ ctx[1]);
    	product.$on("delete", /*delete_handler*/ ctx[2]);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Product, appName });
    	...
    	return [appName, add_to_cart_handler, delete_handler];
    }
