    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 21, 6, 528);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 7, 0, 137);
    			attr_dev(header, "class", "svelte-1jlphc6");
    			add_location(header, file$1, 9, 2, 226);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 12, 2, 275);
    			add_location(p, file$1, 16, 4, 330);
    			add_location(button, file$1, 17, 4, 403);
    			add_location(div2, file$1, 15, 2, 320);
    			add_location(footer, file$1, 19, 2, 470);
    			attr_dev(div3, "class", "modal svelte-1jlphc6");
    			add_location(div3, file$1, 8, 0, 204);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
