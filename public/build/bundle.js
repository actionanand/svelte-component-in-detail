...
var app = (function () {
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 14, 6, 208);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 4, 0, 23);
    			attr_dev(header, "class", "svelte-1jlphc6");
    			add_location(header, file$1, 6, 2, 74);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 9, 2, 123);
    			add_location(footer, file$1, 12, 2, 168);
    			attr_dev(div2, "class", "modal svelte-1jlphc6");
    			add_location(div2, file$1, 5, 0, 52);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (31:0) {#each products as product}
    function create_each_block(ctx) {
    	let product;
    	let current;
    	const product_spread_levels = [/*product*/ ctx[2]];
    	let product_props = {};
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			? get_spread_update(product_spread_levels, [get_spread_object(/*product*/ ctx[2])])
    			: {};
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(31:0) {#each products as product}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 40, 2, 713);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 43, 2, 759);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
