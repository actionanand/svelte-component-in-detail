    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 41, 6, 1003);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			p = element("p");
    			p.textContent = "Before you close, you must agree to our terms and conditions!";
    			t4 = space();
    			button = element("button");
    			...
    			attr_dev(div0, "class", "backdrop svelte-1u3v4x8");
    			add_location(div0, file$1, 27, 0, 612);
    			attr_dev(header, "class", "svelte-1u3v4x8");
    			add_location(header, file$1, 29, 2, 701);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 32, 2, 750);
    			add_location(p, file$1, 36, 4, 805);
    			add_location(button, file$1, 37, 4, 878);
    			add_location(div2, file$1, 35, 2, 795);
    			add_location(footer, file$1, 39, 2, 945);
    			attr_dev(div3, "class", "modal svelte-1u3v4x8");
    			add_location(div3, file$1, 28, 0, 679);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
