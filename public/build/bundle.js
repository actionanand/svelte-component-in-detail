...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 15, 2, 272);
    			add_location(h2, file$1, 16, 2, 291);
    			add_location(button0, file$1, 20, 2, 353);
    			add_location(button1, file$1, 21, 2, 407);
    			add_location(article, file$1, 14, 0, 260);
    		},
    ...
    class Product extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { title: 0, price: 1, bestSeller: 2 });
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(30:0) {#each products as product}",
    		ctx
    	});
